...
pub(crate) mod simd {
    ...
    pub fn simd_eq_bitmask(chunk: ChunkSimd,
        ...
        unsafe {
            ...
            (check_bytes_eq_avx512(chunk, delimiters), check_bytes_eq_avx512(chunk, quotes), check_bytes_eq_avx512(chunk, newlines), check_bytes_eq_avx512(chunk, returns))
        }
    }
...
pub(crate) mod simd {
    ...
    pub fn simd_eq_bitmask(chunk: ChunkSimd,
        ...
        unsafe {
            ...
            (check_bytes_eq_avx2(chunk, delimiters), check_bytes_eq_avx2(chunk, quotes), check_bytes_eq_avx2(chunk, newlines), check_bytes_eq_avx2(chunk, returns))
...
pub(crate) mod simd {
    use core::arch::aarch64::*;
    pub(crate) type ChunkSimd = uint8x16x4_t;
    ...
    pub fn simd_eq_bitmask(chunk: ChunkSimd,
        ...
        unsafe {
            ...
            (check_bytes_eq_neon(chunk, delimiters), check_bytes_eq_neon(chunk, quotes), check_bytes_eq_neon(chunk, newlines), check_bytes_eq_neon(chunk, returns))
        }
    }
