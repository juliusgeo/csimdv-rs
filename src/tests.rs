...
use std::fs::File;
    ...
    //     assert_eq!(result.to_vec(), vec!["1".to_string(), "2".to_string(), "30".to_string(), "300, 400".to_string(),  "4".to_string()])
    // }
    //
    // #[test]
    ...
    //     };
    //     let result = p.read_line();
    //     assert_eq!(result.to_vec(), vec![", \"".to_string(), "1".to_string(), "2".to_string(), "300, 400".to_string(),  "4".to_string()])
    // }
    //
    // #[test]
    ...
    //     };
    //     let result = p.read_line();
    //     assert_eq!(result.to_vec(), vec![", \"".to_string(), "1".to_string(), "2".to_string(), "300,\r\n 400".to_string(),  "4".to_string()])
    // }
    //
    // #[test]
    ...
    //     assert_eq!(result.to_vec()[result.len() -2], "offscore blah blah".to_string())
    // }
    //
    //
    // #[test]
    ...
    //     let result = p.read_line();
    //     println!("{:?}", result.to_vec());
    //     assert_eq!(result.to_vec()[result.len()-4], "D.Bailey kicks 69 yards from DAL 35 to NYG -4. D.Wilson to NYG 16 for 20 yards (A.Holmes).".to_string())
    // }
    //
    // #[test]
    ...
    //     let result = p.read_line();
    //     println!("{:?}", result.to_vec());
    //     assert_eq!(result.to_vec()[result.len()-4], "(14:49) E.Manning pass short middle to V.Cruz to NYG 21 for 5 yards (S.Lee) [J.Hatcher].".to_string())
    // }
    //
    // #[test]
    ...
    //     let result = p.read_line();
    //     // println!("{:?}", result);
    //     assert_eq!(&result[result.len()-4], "(12:09) A.Bradshaw left tackle to NYG 15 for 2 yards (J.Hatcher J.Price-Brent).".as_bytes());
    //     assert_eq!(&result[result.len()-1], "2012".as_bytes());
    // }
    //
    // #[test]
